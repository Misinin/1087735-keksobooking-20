...
(function () {
   ...
   * @return {Object}
   */
    renderCardOffer: function (objectOffer) {
      ...
      clonedOfferItem.querySelector('.popup__text--capacity').textContent = rooms + ' ' + pluralizeRus(rooms, DATA.wordForms.room) +
      ' для ' + guests + ' ' + pluralizeRus(guests, DATA.wordForms.guest);
      clearFieldFeatures();
